 ...
 * @ORM\Entity(repositoryClass="GSB\CovoitBundle\Repository\historique_demandeRepository")
 */
class historique_demande
{
    /**
     * @var int
     *
	 * @ORM\Id
	 * @ORM\ManyToOne(targetEntity="GSB\CovoitBundle\Entity\historique_trajet")
